...
def lovd(input, output):
    ...
    txt2.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
    ...
    df1 = df1.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
    ...
    txt3 = txt3.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    txt31 = '''{{individualid}}\t{{diseaseid}}'''
    df2_header2 = io.StringIO(txt31)
    txt31 = pd.read_csv(df2_header2, sep="\t")
    txt31 = txt31.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False,
                         sep='\t', float_format='%d', mode='a')
    df2 = df.iloc[:, 19:21]  ## Individuals_To_Diseases ##
    df2 = df2.dropna()
    df2 = df2.drop_duplicates(subset=['{{individualid}}'])
    df2.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", header=0, index=False,
               sep='\t', float_format='%d', mode='a')
    txt4 = '''## Phenotypes ## Do not remove or alter this header ##'''
    df3_header = io.StringIO(txt4)
    txt4 = pd.read_csv(df3_header, sep="\t")
    txt4 = txt4.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    ...
    df3.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
               float_format='%d', mode='a')
    txt5 = '''## Screenings ## Do not remove or alter this header ##'''
    df4_header = io.StringIO(txt5)
    txt5 = pd.read_csv(df4_header, sep="\t")
    txt5 = txt5.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    ...
    df4.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
               float_format='%d', mode='a')
    txt6 = '''## Screenings_To_Genes ## Do not remove or alter this header ##'''
    df5_header = io.StringIO(txt6)
    txt6 = pd.read_csv(df5_header, sep="\t")
    txt6 = txt6.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    df5 = df.iloc[:, 43:45]  ## Screenings_To_Genes ## Do not remove or alter this header ##
    df5 = df5.dropna(subset=['{{screeningid}}'])
    df5.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
               float_format='%d', mode='a')
    txt7 = '''## Variants_On_Genome ## Do not remove or alter this header ##'''
    df6_header = io.StringIO(txt7)
    txt7 = pd.read_csv(df6_header, sep="\t")
    txt7 = txt7.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    ...
    df6.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
               float_format='%d', mode='a')
    ...
    txt8 = txt8.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    ...
    df7.to_csv("C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt", index=False, sep='\t',
               float_format='%d', mode='a')
    txt9 = '''## Screenings_To_Variants ## Do not remove or alter this header ##\r\n'''
    df8_header = io.StringIO(txt9)
    txt9 = pd.read_csv(df8_header, sep="\t")
    txt9 = txt9.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False, sep='\t',
                       float_format='%d', mode='a')
    txt10 = '''{{screeningid}}\t{{variantid}}'''
    df8_header2 = io.StringIO(txt10)
    txt10 = pd.read_csv(df8_header2, sep="\t")
    txt10 = txt10.to_csv('C:/Users/Engineering/Documents/Rudzik/work/LOVD/Hosono 2018/output.txt', index=False,
                         sep='\t', float_format='%d', mode='a')
